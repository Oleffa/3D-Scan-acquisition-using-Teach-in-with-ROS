...
public:		
	...
	CRequest(BYTE CommandGroup, 
			BYTE Command, 
			std::vector<CData*>& ResponseBuildup, 
	...
	BYTE getCommandGroup() const {return m_CommandGroup;}
	...
	size_t getResponseBuildupSize() const {return m_ResponseBuildup.size();}		
