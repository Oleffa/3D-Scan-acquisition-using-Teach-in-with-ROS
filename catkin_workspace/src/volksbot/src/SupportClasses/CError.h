...
//////////////////////////////////////////////////////////////////////////////
	CError(){m_sErrorType = "Unknown";}

//////////////////////////////////////////////////////////////////////////////
///  @brief constructor
//////////////////////////////////////////////////////////////////////////////
	CError(	const std::string& ErrorType)
	 		: 	m_sErrorType(ErrorType) {m_Timestamp.update();}
...
//////////////////////////////////////////////////////////////////////////////	
	CError( 	const std::string& ErrorType,
	 		...
	 		:	m_sErrorType(ErrorType),
	 			m_sMethodName(MethodName) {m_Timestamp.update();}	
...
//////////////////////////////////////////////////////////////////////////////	
	CError( 	const std::string& ErrorType,
	 			const std::string& MethodName,
	 			const std::string& correspondDataName)
	 		:	m_sErrorType(ErrorType),
	 			m_sMethodName(MethodName),
	 			m_sCorrespondDataName(correspondDataName) {m_Timestamp.update();}	
...
//////////////////////////////////////////////////////////////////////////////		
	CError( 	const std::string& ErrorType,
	 		...
	 		:	m_sErrorType(ErrorType),
	 			m_sMethodName(MethodName),
	 			m_correspondMessage(correspondMessage) {m_Timestamp.update();}	
...
///  @returns error type
//////////////////////////////////////////////////////////////////////////////
	std::string getErrorType() const {return m_sErrorType;}
	
//////////////////////////////////////////////////////////////////////////////
///  @brief returns the name of the method were the error occurred
///  @returns method name
//////////////////////////////////////////////////////////////////////////////
	std::string getMethodName() const {return m_sMethodName;}
	
//////////////////////////////////////////////////////////////////////////////
///  @brief return the error string of the VMC
///  @returns error string
//////////////////////////////////////////////////////////////////////////////
	std::string getErrorString() const {return m_sErrorString;}
	
//////////////////////////////////////////////////////////////////////////////
///  @brief return the Name of the VMC Parameter
///  @returns error string
//////////////////////////////////////////////////////////////////////////////
	std::string getcorrespondDataName() const {return m_sCorrespondDataName;}
	
//////////////////////////////////////////////////////////////////////////////
///  @brief return the timestamp when the error occurred
///  @returns timestamp
//////////////////////////////////////////////////////////////////////////////
	long double getTimestamp() const {return m_Timestamp.getTime();}

//////////////////////////////////////////////////////////////////////////////
///  @brief return the corresponding message by which the error occurred
///  @returns CMessage object
//////////////////////////////////////////////////////////////////////////////
	CMessage getCorrespondMessage() const {return m_correspondMessage;}
