...
public:		
	...
	CMultisend() {m_bInitialized = false;}

	CMultisend(	CTranslationLayer* Trans,
			...
			:	m_pTrans(Trans),
				m_pNextRequestCommand(pNextRequestCommand),
		 		...
		 		m_Command(nCommand),
		 		m_DataType(DataType) {m_bInitialized = true;}
	...
	bool Set(	const double Motor1 = 0, 
				const double Motor2 = 0, 
				const double Motor3 = 0,
				const double Motor4 = 0, 
				const double Motor5 = 0, 
				const double Motor6 = 0,
				const double Motor7 = 0, 
				const double Motor8 = 0, 
				const double Motor9 = 0,
				const double Motor10 = 0);
